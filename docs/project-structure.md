...
- Owner-scoped tracked schedule resolution belongs in `server/src/features/upcoming`; Upcoming query state, agenda entries, and calendar rendering belong in `client/src/features/upcoming`.
