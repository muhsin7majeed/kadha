...
- [x] Dedicated global upcoming-movie discovery feed.
...
- [x] Private tracked-release calendar with list and month views for past 90 days through the next 90 days, including local watched state for historical releases.
...
- [x] Custom collections for movies and TV shows, with device-local Grid, List, and Table views across private, shared, and public collection details.
...
- [x] Admin dashboard with responsive administration navigation, feedback attention summaries, user growth and recorded-activity trends, privacy-conscious instance metrics, focused account lookup and role management, and provider usage monitoring.
...
- [x] Add direct Letterboxd ZIP import for active film tracking, ratings, and diary events with full-screen TMDB movie-match review, selective inclusion, progress, and manual assignment for ambiguous diary entries.
