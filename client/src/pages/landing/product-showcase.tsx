...
const SLIDES = [
  {
    ...
    description:
      "See movies, rewatches, and individual episodes across a private viewing diary.",
  ...
  },
  {
    ...
    description:
      "Follow several series at once and jump straight to the next aired episode.",
  ...
  },
  {
    ...
    description:
      "Publish a read-only collection while the rest of your viewing stays private.",
  ...
  },
  {
    ...
    description:
      "Choose separate visibility rules for your profile, watched list, likes, and watchlist.",
      ...
      <Container maxW="6xl" px={{ base: 4, md: 6 }}>
        <VStack gap={4} mb={{ base: 8, md: 12 }} textAlign="center">
          ...
          <Text color="fg.muted" textStyle="lead" maxW="2xl">
            Keep a private record for yourself, then share collections only when
            it helps.
          </Text>
        </VStack>
        ...
        <Box
          ...
          _focusVisible={{
            boxShadow:
              "0 0 0 3px var(--chakra-colors-color-palette-focus-ring)",
          }}
          rounded="xl"
        >
          <Box
              ...
              {SLIDES.map((slide, index) => (
                ...
                >
                  ...
                  >
                    <Text
                      fontWeight="semibold"
                      textStyle={{ base: "compactLabel", md: "sectionTitle" }}
                    >
                      {slide.title}
                    </Text>
                    <Text
          ...
          <VisuallyHidden role="status" aria-live="polite">
            {SLIDES[activeIndex].title}, slide {activeIndex + 1} of{" "}
            {SLIDES.length}
          </VisuallyHidden>
                ...
                return (
                  ...
                  >
                    <Box
                      ...
                      transition={
                        prefersReducedMotion ? undefined : "width 160ms ease"
                      }
                    />
                  </Button>
                );
